...
When I felt that it would clarify my process, I've included two or more
DFAs for the exercises below. In any case where more than one DFA exists for an
exercise, the DFA which provides the answer to the exercise is the last one listed, in
alphabetical order. 
